# Shortened URL Redirect-in-Go
A simple url redirect program built in golang that reads the redirects to the right url based on the shortened path.

Problem Statement :- https://gophercises.com/exercises/urlshort
